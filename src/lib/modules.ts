export const modules = [
    {
      ...
      keyPoints: [
        "Definition and principles of SSI",
        "Benefits of SSI for individuals and organizations",
    ...
    },
    {
      ...
      keyPoints: [
        ...
        "Privacy considerations in digital identity",
      ],
    },
    {
      id: 3,
      ...
      keyPoints: [
        "Blockchain basics and its relevance to SSI",
        "Decentralized Identifiers (DIDs) and DID methods",
        "Verifiable Credentials and Verifiable Presentations",
        "Blockchain-based identity networks (e.g., Sovrin, uPort)",
      ],
    },
    {
      id: 4,
      ...
      keyPoints: [
        ...
        "Key management and recovery in SSI",
    ...
    },
    {
      ...
      keyPoints: [
        "Overview of SSI frameworks and libraries",
        "Steps to implement an SSI solution",
